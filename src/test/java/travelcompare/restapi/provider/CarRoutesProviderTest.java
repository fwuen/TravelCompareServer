...
public class CarRoutesProviderTest extends SpringTest {
    /**
     * Test für den CarWaysProvider
     */
    @Test
    public void TestCarRoutesProvider() {

        List<Route> routes = null;
        routes = new CarRoutesProvider().findWithFuelType(new Geo(50.268186, 11.848444), new Geo(52.520645, 13.409779), new Date(), FuelType.DIESEL);
